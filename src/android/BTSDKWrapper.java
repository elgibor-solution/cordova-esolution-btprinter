...
public class BTSDKWrapper {
    ...
    private final ProtocolAdapter.ChannelListener mChannelListener = new ProtocolAdapter.ChannelListener() {
        ...
        public void onPaperReady(boolean state) {
            if (state) {
                showToast(BTUtil.getStringFromStringResource(app, "paper_ok"));
            } else {
                closeActiveConnections();
                showToast(BTUtil.getStringFromStringResource(app, "no_paper"));
            }
        }
        ...
        public void onOverHeated(boolean state) {
            if (state) {
              showToast(BTUtil.getStringFromStringResource(app, "overheating"));
            }
        }
        ...
        public void onLowBattery(boolean state) {
            if (state) {
              showToast(BTUtil.getStringFromStringResource(app, "low_battery"));
            }
        }
    };
    ...
    public BTSDKWrapper(CordovaInterface cordova) {
        mCordova = cordova;
        app = cordova.getActivity().getApplication();

        this.errorCode.put(1, BTUtil.getStringFromStringResource(app, "err_no_bt_adapter"));
        this.errorCode.put(2, BTUtil.getStringFromStringResource(app, "err_no_bt_device"));
        this.errorCode.put(3, BTUtil.getStringFromStringResource(app, "err_lines_number"));
        this.errorCode.put(4, BTUtil.getStringFromStringResource(app, "err_feed_paper"));
        this.errorCode.put(5, BTUtil.getStringFromStringResource(app, "err_print"));
        this.errorCode.put(6, BTUtil.getStringFromStringResource(app, "err_fetch_st"));
        this.errorCode.put(7, BTUtil.getStringFromStringResource(app, "err_fetch_tmp"));
        this.errorCode.put(8, BTUtil.getStringFromStringResource(app, "err_print_barcode"));
        this.errorCode.put(9, BTUtil.getStringFromStringResource(app, "err_print_test"));
        this.errorCode.put(10, BTUtil.getStringFromStringResource(app, "err_set_barcode"));
        this.errorCode.put(11, BTUtil.getStringFromStringResource(app, "err_print_img"));
        this.errorCode.put(12, BTUtil.getStringFromStringResource(app, "err_print_rect"));
        this.errorCode.put(13, BTUtil.getStringFromStringResource(app, "err_print_rect"));
        this.errorCode.put(14, BTUtil.getStringFromStringResource(app, "err_print_rect"));
        this.errorCode.put(15, BTUtil.getStringFromStringResource(app, "err_print_rect"));
        this.errorCode.put(16, BTUtil.getStringFromStringResource(app, "err_print_rect"));
        this.errorCode.put(17, BTUtil.getStringFromStringResource(app, "err_print_rect"));
        this.errorCode.put(18, BTUtil.getStringFromStringResource(app, "failed_to_connect"));
        this.errorCode.put(19, BTUtil.getStringFromStringResource(app, "err_bt_socket"));
        this.errorCode.put(20, BTUtil.getStringFromStringResource(app, "failed_to_initialize"));
    }
    ...
    private void establishBluetoothConnection(final String address, final CallbackContext callbackContext) {
        ...
        runJob(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    showToast(BTUtil.getStringFromStringResource(app, "printer_connected"));
        ...
        }, BTUtil.getStringFromStringResource(app, "printer"), BTUtil.getStringFromStringResource(app, "connecting"));
    }
    ...
    private BluetoothSocket createBluetoothSocket(BluetoothDevice device, UUID uuid, final CallbackContext callbackContext) throws IOException {
        try {
            ...
            showError(BTUtil.getStringFromStringResource(app, "failed_to_comm") + ": " + e.getMessage(), false);
        }
...
//        });
    ...
    private void sendStatusUpdate(boolean isConnected) {
        final Intent intent = new Intent("BTPrinter.connectionStatus");
