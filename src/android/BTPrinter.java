...
public class BTPrinter extends CordovaPlugin {
	...
	public void initialize(CordovaInterface cordova, CordovaWebView webView) {
		...
		printer = new BTSDKWrapper(cordova);
		...
		switch (option) {
			...
			case disconnect:
				try {
					...
					callbackContext.success(BTUtil.getStringFromStringResource(this.cordova.getActivity().getApplication(), "printer_disconnected"));
				} catch (Exception e) {
					callbackContext.success(BTUtil.getStringFromStringResource(this.cordova.getActivity().getApplication(), "err_disconnect_printer"));
				}
				break;
			case feedPaper:
